"""Handler for `COMPOSIO_REMOTE_WORKBENCH`.

Workbench responses are stateful (Python sandbox) — not cacheable.
Tokenize for visibility; otherwise transparent.
"""
